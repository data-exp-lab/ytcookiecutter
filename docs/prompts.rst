...
include_yt_requirements
    whether to include yt-related requirements in resulting requirements.txt file. This will include yt and some additional optional requirements.
